...
try {
  if (body && body.length <= MAX_BODY_SIZE) {
    ...
    const swaps = [
      ...
      ["qad_device_platform", "qxx_device_platform"],
      ["adpass=", "xxpass="],
      ["adversion=", "xxversion="],
      ["adchid=", "xxchid="],
      ["TADChid/0", "TXXChid/0"],
      ["kNoSubAdType", "kNoSubXxType"],
      ["last_contract_ad_timestamp", "last_contract_xx_timestamp"],
      ["cache_ad", "cache_xx"],
      ["ad.page.detail.vipbtn", "xx.page.detail.vipbtn"],
      ["FILTER-ADD", "FILTER-XXX"],
      ["RERANK-ADD", "RERANK-XXX"],
