      ...
      if (looksLikeJson(rewritten, ct)) {
        ...
        if (hasHardAdSignal || (hasSoftPromotionModule && !hasPageState)) {
          const swaps = [
            ...
            ["ad_nfb_bad_content", "xx_nfb_bad_content"],
            ["ad_nfb_dislike", "xx_nfb_dislike"],
            ["ad_nfb_repetition", "xx_nfb_repetition"],
            ["ad_nfb_direct_close", "xx_nfb_direct_close"],
            ["ad_nfb_dislike_brand", "xx_nfb_dislike_brand"],
            ["ad_vid", "xx_vid"],
            ["ad_is_bidding", "xx_is_bidding"],
            ["ad_product_id", "xx_product_id"],
            ["ad_flush_num", "xx_flush_num"],
            ["ad_highlight", "xx_highlight"],
            ["ad_pr_id", "xx_pr_id"],
            ["ad_trans_native", "xx_trans_native"],
            ["ad_duration", "xx_duration"],
            ["ad_reportkey_scd", "xx_reportkey_scd"],
            ["ad_cast_type", "xx_cast_type"],
            ["ad_interaction_type", "xx_interaction_type"],
            ["ad_reportkey_fst", "xx_reportkey_fst"],
            ["ad_is_fail", "xx_is_fail"],
            ["ad_empty_reason", "xx_empty_reason"],
            ["ad_old_action_type", "xx_old_action_type"],
            ["ad_norms", "xx_norms"],
            ["ad_orderid", "xx_orderid"],
            ["ad_report_params", "xx_report_params"],
            ["ad_return_num", "xx_return_num"],
            ["ad_num", "xx_num"],
